...
const WelcomePage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#020208] p-4 overflow-hidden relative selection:bg-orange-500/30">
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
                ...
                <div className="space-y-8">
                    ...
                    <div className="welcome-tagline space-y-6">
                        ...
                        {/* Futuristic Scanner Loading */}
                        <div className="flex flex-col items-center gap-4">
                            <div className="w-48 h-[1px] bg-white/10 relative overflow-hidden">
                                <div className="absolute inset-0 bg-orange-500 w-1/2 animate-scan"></div>
                            </div>
                            <p className="text-[8px] font-black text-orange-500/40 uppercase tracking-[0.3em] animate-pulse">Syncing Global Nodes...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <style>{`
                @keyframes rotate { from { transform: rotate(0deg) scale(var(--tw-scale-x)); } to { transform: rotate(360deg) scale(var(--tw-scale-x)); } }
                @keyframes scan { 0% { transform: translateX(-100%); } 100% { transform: translateX(200%); } }
                
                .welcome-logo-container { opacity: 0; animation: reveal 1.5s cubic-bezier(0.22, 1, 0.36, 1) 0.5s forwards; }
                .welcome-namaste { opacity: 0; animation: revealUp 1.2s ease-out 1s forwards; }
                .welcome-title { opacity: 0; animation: revealUp 1.2s ease-out 1.3s forwards; }
                .welcome-tagline { opacity: 0; animation: revealUp 1.2s ease-out 1.6s forwards; }
